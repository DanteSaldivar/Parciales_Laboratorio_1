...
int convertirTipoSalonInt(char* tipoSalon)
{
	int retorno = -1;
	int aux;
	if(tipoSalon != NULL)
	{
		aux = strcmp(tipoSalon,"Local");
...
int convertirTipoSalonChar(int tipoSalon, char*pTipoSalon)
{
	int retorno = -1;
	...
	if(tipoSalon > 0)
	{
		...
		{
		case 1:
			strcpy(pTipoSalon, "Shopping");
			break;
		case 2:
			strcpy(pTipoSalon, "Local");
			break;
		}
		retorno = 0;
	}
...
///ARCADE
int convertirTipoSonido(char* pTipoSonido)
{
	int retorno = -1;
	int aux;
...
int convertirTipoSonidoChar(int tipoSonido, char*pTipoSonido)
{
	int retorno = -1;

	if(tipoSonido > 0 && pTipoSonido != NULL)
	{
		switch (tipoSonido)
		{
		case 1:
			strcpy(pTipoSonido, "Mono");
			break;
		case 2:
			strcpy(pTipoSonido, "Stereo");
			break;
		}
		retorno = 0;
	}
...
int convertirCantidadJugadores(int cantidadJugadores)
{
	int retorno = -1;
...
int convertirGeneroInt (char* pTipoGenero)
{
	int retorno = -1;

	if(pTipoGenero != NULL)
	{
		if(strcmp(pTipoGenero,"Plataforma") == 0)
		{
			retorno = 1;
		}
		else
		{
			if(strcmp(pTipoGenero,"Laberinto") == 0)
			{
				retorno = 2;
			}
			else
			{
				if(strcmp(pTipoGenero,"Aventura") == 0)
				{
					retorno = 3;
				}
				else
...
int convertirGeneroChar(int generoInt, char* pTipoGenero)
{
	int retorno = -1;

	if(generoInt > 0 && generoInt < 5 && pTipoGenero != NULL)
	{
		switch(generoInt)
		{
		case 1:
			strcpy(pTipoGenero,"Plataforma");
			break;
		case 2:
			strcpy(pTipoGenero,"Laberinto");
			break;
		case 3:
			strcpy(pTipoGenero,"Aventura");
			break;
		case 4:
			strcpy(pTipoGenero,"Otro");
			break;
		}
		retorno = 0;
	}
